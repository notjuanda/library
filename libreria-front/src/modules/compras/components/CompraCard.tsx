...
const CompraCard: React.FC<Props> = ({ compra }) => {
    return (
        ...
        <p className="text-sm font-bold">Monto Total: ${compra.monto_total.toFixed(2)}</p>
        <p className="text-sm">Estado: <span className={
